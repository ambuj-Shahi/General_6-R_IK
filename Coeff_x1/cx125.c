...
double dummyexp = -8*pow(mu6*(a6*ly*mx - a6*lx*my + my*px - mx*py) + lambda6*(a6*ly*nx - a6*lx*ny + ny*px - nx*py),-1)*(a2*lambda3*mu5*(mu6*(a6*ly*mx - a6*lx*my + my*px - mx*py) + lambda6*(a6*ly*nx - a6*lx*ny + ny*px - nx*py)) + (a1*a5*lambda4*mu2*pow(mu1,-1)*(pow(mx,2) + pow(my,2) + pow(nx,2) + pow(ny,2) + cos(2*alpha6)*(-pow(mx,2) - pow(my,2) + pow(nx,2) + pow(ny,2)) + 2*(mx*nx + my*ny)*sin(2*alpha6)))/2.);
