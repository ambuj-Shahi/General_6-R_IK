...
double dummyexp = -4*pow(mu6*(a6*ly*mx - a6*lx*my + my*px - mx*py) + lambda6*(a6*ly*nx - a6*lx*ny + ny*px - nx*py),-1)*(mu4*(a2*lambda2*lambda5*(mu6*(a6*ly*mx - a6*lx*my + my*px - mx*py) + lambda6*(a6*ly*nx - a6*lx*ny + ny*px - nx*py)) + mu2*(-(lambda6*((a4 + a5)*mu5*(a6*ly*nx - a6*lx*ny + ny*px - nx*py) + d5*mu6*(2*d1*(mx*nx + my*ny) - a6*(lx*mz*nx + ly*mz*ny - 2*lz*(mx*nx + my*ny) + lx*mx*nz + ly*my*nz) + mz*nx*px + mx*nz*px + mz*ny*py + my*nz*py))) + mu6*(-((a4 + a5)*mu5*(a6*ly*mx - a6*lx*my + my*px - mx*py)) + 2*d5*lambda6*(mx*nx + my*ny)*pz - d5*mu6*(mx*mz*px + my*mz*py - pz*pow(mx,2) - pz*pow(my,2) + d1*(pow(mx,2) + pow(my,2)) + a6*(-((lx*mx + ly*my)*mz) + lz*(pow(mx,2) + pow(my,2))))) - d5*pow(lambda6,2)*(nx*nz*px + ny*nz*py - pz*pow(nx,2) - pz*pow(ny,2) + d1*(pow(nx,2) + pow(ny,2)) + a6*(-((lx*nx + ly*ny)*nz) + lz*(pow(nx,2) + pow(ny,2)))) + lambda5*(-(d6*pow(mu6,2)*(mx*mz*px + my*mz*py - pz*pow(mx,2) - pz*pow(my,2) + d1*(pow(mx,2) + pow(my,2)) + a6*(-((lx*mx + ly*my)*mz) + lz*(pow(mx,2) + pow(my,2))))) - d6*pow(lambda6,2)*(nx*nz*px + ny*nz*py - pz*pow(nx,2) - pz*pow(ny,2) + d1*(pow(nx,2) + pow(ny,2)) + a6*(-((lx*nx + ly*ny)*nz) + lz*(pow(nx,2) + pow(ny,2)))) + mu6*(d1*mx*px + d1*my*py - mx*px*pz - my*py*pz + a6*(-(d1*(lx*mx + ly*my)) + lz*mx*px - 2*lx*mz*px + lz*my*py - 2*ly*mz*py + lx*mx*pz + ly*my*pz) + pow(a6,2)*(-(lx*lz*mx) + ly*(-(lz*my) + ly*mz) + mz*pow(lx,2)) - a1*lambda1*(a6*ly*mx - a6*lx*my + my*px - mx*py)*pow(mu1,-1) + mz*pow(px,2) + mz*pow(py,2)) + lambda6*(-(a6*d1*lx*nx) - a6*d1*ly*ny + d1*nx*px + a6*lz*nx*px - 2*a6*lx*nz*px + d1*ny*py + a6*lz*ny*py - 2*a6*ly*nz*py - d6*mu6*(2*d1*(mx*nx + my*ny) - a6*(lx*mz*nx + ly*mz*ny - 2*lz*(mx*nx + my*ny) + lx*mx*nz + ly*my*nz) + mz*nx*px + mx*nz*px + mz*ny*py + my*nz*py) + a6*lx*nx*pz + a6*ly*ny*pz - nx*px*pz - ny*py*pz - lx*lz*nx*pow(a6,2) - ly*lz*ny*pow(a6,2) + nz*pow(a6,2)*pow(lx,2) + nz*pow(a6,2)*pow(ly,2) - a1*lambda1*(a6*ly*nx - a6*lx*ny + ny*px - nx*py)*pow(mu1,-1) + nz*pow(px,2) + nz*pow(py,2)) + d6*(mx*nx + my*ny)*pz*sin(2*alpha6)))) + lambda4*((a4 + a5)*lambda5*mu2*(mu6*(a6*ly*mx - a6*lx*my + my*px - mx*py) + lambda6*(a6*ly*nx - a6*lx*ny + ny*px - nx*py)) + mu5*(a2*lambda2*(mu6*(a6*ly*mx - a6*lx*my + my*px - mx*py) + lambda6*(a6*ly*nx - a6*lx*ny + ny*px - nx*py)) + mu2*(-(d6*pow(mu6,2)*(mx*mz*px + my*mz*py - pz*pow(mx,2) - pz*pow(my,2) + d1*(pow(mx,2) + pow(my,2)) + a6*(-((lx*mx + ly*my)*mz) + lz*(pow(mx,2) + pow(my,2))))) - d6*pow(lambda6,2)*(nx*nz*px + ny*nz*py - pz*pow(nx,2) - pz*pow(ny,2) + d1*(pow(nx,2) + pow(ny,2)) + a6*(-((lx*nx + ly*ny)*nz) + lz*(pow(nx,2) + pow(ny,2)))) + mu6*(d1*mx*px + d1*my*py - mx*px*pz - my*py*pz + a6*(-(d1*(lx*mx + ly*my)) + lz*mx*px - 2*lx*mz*px + lz*my*py - 2*ly*mz*py + lx*mx*pz + ly*my*pz) + pow(a6,2)*(-(lx*lz*mx) + ly*(-(lz*my) + ly*mz) + mz*pow(lx,2)) - a1*lambda1*(a6*ly*mx - a6*lx*my + my*px - mx*py)*pow(mu1,-1) + mz*pow(px,2) + mz*pow(py,2)) + lambda6*(-(a6*d1*lx*nx) - a6*d1*ly*ny + d1*nx*px + a6*lz*nx*px - 2*a6*lx*nz*px + d1*ny*py + a6*lz*ny*py - 2*a6*ly*nz*py - d6*mu6*(2*d1*(mx*nx + my*ny) - a6*(lx*mz*nx + ly*mz*ny - 2*lz*(mx*nx + my*ny) + lx*mx*nz + ly*my*nz) + mz*nx*px + mx*nz*px + mz*ny*py + my*nz*py) + a6*lx*nx*pz + a6*ly*ny*pz - nx*px*pz - ny*py*pz - lx*lz*nx*pow(a6,2) - ly*lz*ny*pow(a6,2) + nz*pow(a6,2)*pow(lx,2) + nz*pow(a6,2)*pow(ly,2) - a1*lambda1*(a6*ly*nx - a6*lx*ny + ny*px - nx*py)*pow(mu1,-1) + nz*pow(px,2) + nz*pow(py,2)) + d6*(mx*nx + my*ny)*pz*sin(2*alpha6)))));
