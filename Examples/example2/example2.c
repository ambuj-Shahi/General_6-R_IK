/** 
 ...
 @brief This file demonstrates the use of the Inverse kinematics function 'InverseKinematicsGeneral6R', through an example on a general 6-R serial manipulator, taken from
        the 2007 paper by 'Liu and Zhu', on this topic.
...
int main() 
{
    ...
    */ 
    ...
    CsvParser *csvparser1 = CsvParser_new("dhmat_Liu_Zhu.csv", ",", 0);
    CsvRow *row1;
    double dhmat[10][10];
    ...
    */ 
    ...
    int ii = 0, jj;
    CsvParser *csvparser2 = CsvParser_new("eemat_Liu_Zhu.csv", ",", 0);
    CsvRow *row2;
    double eemat[10][10];
