/** 
 ...
 @file csvparser.c
 @brief This file is used to read CSV files. Its usage is demonstrated in the example files, 
         where it is used to form the 'dhmat' and 'eemat' which serves as input to the IK function 'IK_Gen_6R'.
