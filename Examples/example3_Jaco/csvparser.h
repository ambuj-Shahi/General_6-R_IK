/** 
 ...
 @file csvparser.h
 @brief This file contains definition of the functions used in the file csvparser.c, which is used to read CSV files to form the 'dhmat' and 'eemat'
        which serves as input to the IK function 'IK_Gen_6R'.
