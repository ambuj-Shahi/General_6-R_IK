/** 
 ...
 @file example3.c 
 @brief This file demonstrates the use of the Inverse kinematics function 'InverseKinematicsGeneral6R', through an example on the general 6-R serial manipulator, Jaco. For this
        manipulator the D-H parameter a1 = 0 m. For this algorithm to work, 'a1' is taken as 0.001 m, and it is found that the residues still are of the order
        of 10^-6.
...
int main() 
{
    ...
    */ 
    ...
    CsvParser *csvparser1 = CsvParser_new("dhmat_Jaco.csv", ",", 0);
    CsvRow *row1;
    double dhmat[10][10];
    ...
    */ 
    ...
    int ii = 0, jj;
    CsvParser *csvparser2 = CsvParser_new("eemat_Jaco.csv", ",", 0);
    CsvRow *row2;
    double eemat[10][10];
