...
double dummyexp = 4*(lambda6*((a2 + a3)*d5*mu4*(a6*ly*nx - a6*lx*ny + ny*px - nx*py) + (a4 + a5)*mu3*(d3*(a6*ly*nx - a6*lx*ny + ny*px - nx*py) - lambda2*(-(d2*mu1*(a6*ly*nx - a6*lx*ny + ny*px - nx*py)) + a1*(a6*lx*nx + a6*ly*ny + 2*d6*mu6*(mx*nx + my*ny) - nx*px - ny*py))*pow(mu1,-1))) - mu6*(-((a2 + a3)*d5*mu4*(a6*ly*mx - a6*lx*my + my*px - mx*py)) + (a4 + a5)*mu3*(d3*(-(a6*ly*mx) + a6*lx*my - my*px + mx*py) + lambda2*(d2*(-(a6*ly*mx) + a6*lx*my - my*px + mx*py) + a1*pow(mu1,-1)*(a6*lx*mx + a6*ly*my - mx*px - my*py + d6*mu6*(pow(mx,2) + pow(my,2)))))) - a1*(a4 + a5)*d6*lambda2*mu3*pow(lambda6,2)*pow(mu1,-1)*(pow(nx,2) + pow(ny,2)) + ((a4 + a5)*lambda3*mu2*(4*d2*mu6*(a6*ly*mx - a6*lx*my + my*px - mx*py) - 4*lambda6*(-(d2*mu1*(a6*ly*nx - a6*lx*ny + ny*px - nx*py)) + a1*(a6*lx*nx + a6*ly*ny + 2*d6*mu6*(mx*nx + my*ny) - nx*px - ny*py))*pow(mu1,-1) + 2*a1*d6*pow(lambda6,2)*pow(mu1,-1)*(pow(mx,2) + pow(my,2) - pow(nx,2) - pow(ny,2)) + a1*pow(mu1,-1)*(-4*mu6*(a6*lx*mx + a6*ly*my - mx*px - my*py) + d6*cos(2*alpha6)*(pow(mx,2) + pow(my,2) - pow(nx,2) - pow(ny,2)) - d6*(3*pow(mx,2) + 3*pow(my,2) + pow(nx,2) + pow(ny,2)))))/4.)*pow(mu6*(a6*ly*mx - a6*lx*my + my*px - mx*py) + lambda6*(a6*ly*nx - a6*lx*ny + ny*px - nx*py),-1);
